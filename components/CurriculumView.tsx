...
const ConfettiCanvas: React.FC = () => {
  ...
  return <canvas ref={canvasRef} className="absolute inset-0 pointer-events-none z-[29000]" />;
};
...
export const CurriculumView: React.FC<CurriculumViewProps> = ({
  ...
  return (
    <div className={`h-full w-full flex flex-col font-sans relative z-10 transition-colors duration-500 text-slate-800 dark:text-slate-200 bg-slate-50 dark:bg-[#0f172a]`}>
      ...
      {showCelebration && (
        <div className="fixed inset-0 z-[30000] flex items-center justify-center bg-gradient-to-br from-black/80 via-purple-900/40 to-black/80 backdrop-blur-md animate-in fade-in duration-700 p-4 sm:p-6 md:p-8">
          <ConfettiCanvas />
          ...
          <div className={`
             relative z-[30001] w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl
             ${isDarkMode
      ...
      <nav className="h-16 md:h-20 flex items-center justify-between px-3 md:px-6 lg:px-10 shrink-0 sticky top-2 z-[20000] bg-white/80 dark:bg-[#0f172a]/80 backdrop-blur-md border border-slate-200 dark:border-white/10 rounded-xl md:rounded-2xl mx-2 md:mx-4 mt-2 relative">
      ...
      {showShortcuts && (
        <div
          className="fixed inset-0 z-[30000] flex items-center justify-center bg-black/50 backdrop-blur-sm"
